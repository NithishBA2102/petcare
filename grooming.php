...
<head>
    ...
    <body>
        ...
        <div>
          <h1>Pet Grooming Bookings</h1>
          <form action="" method="POST">
            <label for="name">User Name:</label>
            <input type="text" id="name"  name="username" placeholder="Enter username" ><br>
            ...
            <label for="time">Grooming_time:</label>
        ...
        <?php
        session_start();
        $username= $services=$name = $breed = $age = $date = $time = "" ;
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
            ...
            $con = mysqli_connect("localhost","root","","pet_care");                      
			        ...
			        $query = "INSERT INTO `grooming` ( username,services,petname,petbreed, petage, date, time, user_email)
               VALUES ( '$username','$services','$name', '$breed', '$age', '$date' , '$time','$user_email')";
