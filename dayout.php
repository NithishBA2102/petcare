    ...
    <body>
        <div>
          ...
          <form action="" method="POST">
            ...
            <label for="time">dayout_time:</label>
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
            ...
            $con = mysqli_connect("localhost","root","","pet_care");                      
			        ...
			        $query = "INSERT INTO `dayout` (username,services, petname,petbreed, petage, date, time, user_email) VALUES ('$username','$services', '$name', '$breed', '$age', '$date' , '$time','$user_email')";
